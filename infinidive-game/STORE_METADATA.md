...
| App icon | 512×512 px, 32-bit PNG with alpha, maximum 1,024 KB | Dedicated raster is 512×512, 72,562 bytes, 8-bit/color RGBA. Recorded format/dimension/size requirements pass; final visual and console-upload review remain |
