...
**Configured isolated branch-fallback URL:** `https://matanita44-sudo.github.io/claude-builders-bounty/infinidive/` — not yet deployed or browser-verified
...
| `../build/web/` | reconciled-tree export; `index.html` 2,493 bytes / SHA-256 `45816aefb5aee806fa83cbb07867f4285f1c23057ff98f083e9a6f7b2202a9f7`; PCK 423,872 / `e1eec1fec850f74b2dd351d00c99eccf0801b8ed4ddc2ad09d0d9382ebea74b3`; WASM 39,514,754 / `fc74679e3b97f76878947fcd4fbe1268cbfa6188182a2e33bbc3f5dc9bfa57d0` | Real Godot Web export passed static validation; build tooling and adaptive sources are excluded. No browser runtime or public deployment is proved. |
...
| `../build/ios-iphone-current/INFINIDIVE.xcodeproj` | reconciled-tree unsigned export: 47 files/~368 MB; PCK 423,968 bytes / SHA-256 `5cab15e7e9bf5a1493abddf4679644380bc4ef9e0613855fdfd8b107820213e6`; pbxproj `dbbc0f658d31f09a8ad0b020a4ef1d1f6072e422088d13c996dd0d09ee7748bb`; 411-byte export options `50c3cbc7d11c6c3c37357dc14e59ef93f1c011897467a9b94bb11637a795ea7d` | Target family 1, bundle/version/iOS 15, exact RGB icons, and absence of Team/placeholder values are verified. It is uncompiled, unsigned, unarchived, uninstalled, and not a TestFlight build. |
...
| `../.github/workflows/infinidive-ci.yml` | authored locally | CI intent exists; no successful remote run or Pages deployment has been verified. |
...
- A fresh reconciled-tree Godot Web export passed static validation; browser runtime remains untested.
...
| Public playable URL | `https://matanita44-sudo.github.io/claude-builders-bounty/infinidive/` is the configured isolated branch fallback, but no successful Pages deployment/runtime smoke has been verified. |
...
| Gate 5 — Release candidate | Not passed | Fresh structural exports exist, but signed native builds, browser/native installs, full QA, P0/P1 closure, final store assets, published privacy/support material, and fresh-install/update evidence are absent. |
...
1. Browser-smoke-test the fresh Web build, run CI/Pages, and verify `https://matanita44-sudo.github.io/claude-builders-bounty/infinidive/` before publishing it as playable.
