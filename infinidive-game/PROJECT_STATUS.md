...
> **Active evidence refresh:** the semantic Web QA candidate is frozen at production fingerprint `1db2d97aa0852a415ee4a76e3d4be6ea20949140dfcdee46e49d295e55525e8e` and tracked tests/CI fingerprint `ff2530d3aad779a21a3b775e8d973ba1b3e3c37a86b5b97cea133801c954dc59`. The query gate now reads `window.location.search` through Godot's JavaScript interface and publishes/deletes the read-only snapshot in the global JavaScript context. Strict editor import plus all 13 local suites passed `28,410/0` with zero engine/script/parse error lines. Fresh source-bound 8.049-second and 90.041-second reports passed with 7/7 projectile models and zero failures. The previous public deployment, 30-minute report, and `e942db6f` packages listed below remain historical evidence until the new commit-bound 30-minute run, Chromium semantic smoke, deploy, and packaging refresh complete; they must not be read as evidence for `1db2d97a`.
...
| `../.github/workflows/infinidive-ci.yml` | Run [33565500042](https://github.com/matanita44-sudo/claude-builders-bounty/actions/runs/33565500042), overall PASS on prior runtime-evidence commit `380b6d4b632e9d507ea42075714d0f18d6cdb74f` | Validate, Web export, Android debug, deploy, and public smoke passed. Long-soak skipped because Validate passed the then-current `e942db6f` 30-minute report. Public-smoke artifact `9823113363` is 90,667 bytes with SHA-256 `5038d055d8cf723b479424b4d099d0e3c036bb4e9eb325cb9c1ee6e00b750985`; its retained frame hashes are `31212c7891fccbb64e3993062614178a854ac29b185878ee1a5db2963ccf2e23` before and `94e6d2654a466e0ecb37670e6621d2b873eb5c9c56c39a5565ea2f38afa0b6d8` after. This is prior-source evidence. |
...
- The retained previous-source CI 30-minute soak passed 1,800.043 seconds, 26,676 cycles, 2,668 restarts/Dives, 1,335 save writes / 22 save reloads, 3,188 queued offline events / 24 queue reloads / final queue 500, peak 540, 7/7 exact model coverage, stable delta 3,667,676 bytes, slope 84,517.9971965645 B/min, complete transaction `5c047f1a630e8e1de5c5ffff`, and zero failures. Its start/end source fingerprint remained `e942db6f8a0f1a47518e8afb468f77c651001a2028fcad0820e71c4d993a6382`; the `1db2d97a` candidate's 30-minute run is pending.
...
1. Execute the new semantic movement/Dash smoke in CI-served and public-host Chromium, then extend its QA whitelist and assertions through breach, Dive, organ destruction, return, and reload persistence before repeating on declared mobile browsers and devices.
