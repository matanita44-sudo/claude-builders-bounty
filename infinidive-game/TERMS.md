...
The reviewed Game provides local, offline play and locally generated Daily Rift and Friend Rift challenges. It does not currently provide an account, cloud save, online leaderboard, remote friend service, advertising, in-app purchases, subscriptions, or paid virtual items. Friend Rift codes are generated locally and leave the Game only when you choose to copy or share them through another service.

Features may be changed, suspended, or removed as development continues. A pre-release build may contain defects, lose compatibility, or change save formats. Current save-recovery measures reduce risk but do not guarantee that local progress can always be recovered.
...
המשחק שנבדק מאפשר משחק מקומי ללא רשת ואתגרי Daily Rift ו־Friend Rift שנוצרים במכשיר. כרגע אין בו חשבון, שמירת ענן, לוח תוצאות מקוון, שירות חברים מרוחק, פרסום, רכישות בתוך האפליקציה, מנויים או פריטים וירטואליים בתשלום. קודי Friend Rift נוצרים מקומית ויוצאים מהמשחק רק כאשר המשתמש בוחר להעתיק או לשתף אותם דרך שירות אחר.

במהלך הפיתוח ייתכן שתכונות ישתנו, יושהו או יוסרו. גרסת טרום־השקה עשויה לכלול תקלות, לאבד תאימות או לשנות פורמט שמירה. אמצעי שחזור השמירה מפחיתים סיכון אך אינם מבטיחים שניתן יהיה לשחזר תמיד התקדמות מקומית.
