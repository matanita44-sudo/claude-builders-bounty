...
> **Current status:** version `0.1.0` is a playable pre-alpha production foundation, not a release candidate. Headless tests plus freshly regenerated Web, debug-APK, and unsigned iPhone-Xcode structural evidence exist for the reconciled tree. GitHub Actions run [33498494206](https://github.com/matanita44-sudo/claude-builders-bounty/actions/runs/33498494206) passed validation, Web export/browser boot smoke, and Android debug export for commit `374bdb5cb8de7f4622917a343e379ff4cfd26232`; deployment alone failed because the workflow integration could not create the GitHub Pages site. There is no verified public playable deployment, live backend transport, production-signed native build, store submission, simulator install, or physical-device QA evidence yet.
...
A fresh reconciled-tree local Web export contains `index.html` (2,618 bytes; SHA-256 `f86b5f1c0f8985d66056f47c4969f8ae8366b5fb256ebc1098900471188e4336`), `index.pck` (423,872 bytes; SHA-256 `dc782fa3546fd464a9e2cf703e00e5675ec9b28f669118159d0e112f27b26a62`), `index.wasm` (39,514,754 bytes; SHA-256 `fc74679e3b97f76878947fcd4fbe1268cbfa6188182a2e33bbc3f5dc9bfa57d0`), worklets, and generated icons. The validation script passed and confirmed that build tooling and adaptive-icon sources are excluded. The remote Pages artifact produced from commit `374bdb5cb8de7f4622917a343e379ff4cfd26232` contains `index.html` (2,618 bytes; SHA-256 `f86b5f1c0f8985d66056f47c4969f8ae8366b5fb256ebc1098900471188e4336`), `index.pck` (423,872 bytes; SHA-256 `b0f971a5f56accfd8eec18683978e4da556c3a582ddfad30462db7ae5685a5a1`), and `index.wasm` (39,514,754 bytes; SHA-256 `fc74679e3b97f76878947fcd4fbe1268cbfa6188182a2e33bbc3f5dc9bfa57d0`). Its CI-served Playwright/Chromium smoke returned HTTP 200, started Godot 4.7.2 with WebGL2, created a 540×960 canvas, hid the loading status, and recorded no page errors. This is real browser boot automation, not touch-gameplay or public-host evidence. CI copies `web_pages/support.html` and `web_pages/privacy.html` beside the exported game. Settings opens those relative paths on Web, so the links remain valid below a repository-specific Pages base path. Native builds target the isolated branch-fallback pages at `https://matanita44-sudo.github.io/claude-builders-bounty/infinidive/support.html` and `https://matanita44-sudo.github.io/claude-builders-bounty/infinidive/privacy.html`; neither the game nor those pages is publicly deployed or verified at that URL yet. The local and remote PCK hashes differ because they were independently exported; each hash is tied to the explicitly named artifact.

Native evidence is development-only:

- `../../build/android/infinidive-debug.apk` is the freshly regenerated reconciled-tree local arm64 debug APK (28,903,975 bytes; SHA-256 `d04ff8f814d9affec0a63b7df55fcca94d68936c4be3733edc747fafbfa32bd7`). The remote CI artifact from commit `374bdb5cb8de7f4622917a343e379ff4cfd26232` is 28,862,289 bytes with SHA-256 `45f1ebc82f1bae1d1cb767456c81fcf405d25b01d5e737c96b06f95084d0ef4c`. Both validate `com.matan.infinidive`, version `0.1.0 (1)`, min SDK 24, target SDK 36, arm64 portrait, exactly the normal `android.permission.VIBRATE` permission, zip alignment, Android Debug Signature Scheme v2/v3, and the adaptive icon. Neither is a Play release AAB, and neither has been installed on an emulator or physical device.
