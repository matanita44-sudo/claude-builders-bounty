...
> **Current candidate refresh:** query-gated semantic Web QA is implemented on source fingerprint `1db2d97aa0852a415ee4a76e3d4be6ea20949140dfcdee46e49d295e55525e8e` with tests/CI fingerprint `ff2530d3aad779a21a3b775e8d973ba1b3e3c37a86b5b97cea133801c954dc59`. Local strict editor plus the 13-suite matrix passed `28,410/0`; fresh 8.049-second and 90.041-second source-bound soaks passed. The public URL and older endurance/packages above still serve the prior runtime commit until the current candidate completes its mandatory 30-minute CI soak, semantic Chromium assertions, deployment, and retained-evidence refresh.
