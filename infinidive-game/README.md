...
> **Current status:** version `0.1.0` is a playable pre-alpha production foundation, not a release candidate. The current working tree passes its local headless, Web-static-export, and Android-debug structural checks. GitHub Actions run [33498494206](https://github.com/matanita44-sudo/claude-builders-bounty/actions/runs/33498494206) remains remote evidence only for commit `374bdb5cb8de7f4622917a343e379ff4cfd26232`; it passed validation, Web export/browser boot smoke, and Android debug export. Pages deployment rerun job [99862926627](https://github.com/matanita44-sudo/claude-builders-bounty/actions/runs/33498494206/job/99862926627) again failed because the integration could not create the Pages site. There is no verified public playable deployment, live backend transport, production-signed native build, store submission, simulator install, or physical-device QA evidence yet.
...
A current-working-tree local Web export contains `index.html` (2,618 bytes; SHA-256 `190b5852ff3c94b4d2e6ce2849bdbc92cb64e77c6cb972d35165b9cf544713b5`), `index.pck` (440,384 bytes; SHA-256 `f9acf67d893ab6513f2b7fde450fcd2129331ba8252b3464132d94892b85b9d4`), `index.wasm` (39,514,754 bytes; SHA-256 `fc74679e3b97f76878947fcd4fbe1268cbfa6188182a2e33bbc3f5dc9bfa57d0`), worklets, and generated icons. Static validation passes and confirms that build tooling and adaptive-icon sources are excluded. The remote Pages artifact produced from older commit `374bdb5cb8de7f4622917a343e379ff4cfd26232` contains `index.html` (2,618 bytes; SHA-256 `f86b5f1c0f8985d66056f47c4969f8ae8366b5fb256ebc1098900471188e4336`), `index.pck` (423,872 bytes; SHA-256 `b0f971a5f56accfd8eec18683978e4da556c3a582ddfad30462db7ae5685a5a1`), and `index.wasm` (39,514,754 bytes; SHA-256 `fc74679e3b97f76878947fcd4fbe1268cbfa6188182a2e33bbc3f5dc9bfa57d0`). Its CI-served Playwright/Chromium smoke returned HTTP 200, started Godot 4.7.2 with WebGL2, created a 540×960 canvas, hid the loading status, and recorded no page errors. This is real browser boot automation for that older commit, not current-tree touch gameplay or public-host evidence. CI copies `web_pages/support.html` and `web_pages/privacy.html` beside the exported game. Settings opens those relative paths on Web, so the links remain valid below a repository-specific Pages base path. Native builds target the isolated branch-fallback pages at `https://matanita44-sudo.github.io/claude-builders-bounty/infinidive/support.html` and `https://matanita44-sudo.github.io/claude-builders-bounty/infinidive/privacy.html`; the game, support page, and privacy page currently return HTTP 404 there and no game canvas is present.

Native evidence is development-only:

- `../../build/android/infinidive-debug.apk` has been regenerated from the current working tree and is 28,878,673 bytes with SHA-256 `2d3d5fa6f283381fd31aa1702df2cc697c80f12d0d7a96e6c1e22b59c33cdcef`. It passes package/version, min 24/target 36, arm64 portrait, exact-permission, alignment, Debug v2/v3, and adaptive-icon validation. The local exporter warned that it fell back to installed build-tools 34.0.4 while targeting SDK 36; production AAB evidence still requires a complete build-tools 36 environment. The remote CI artifact from older commit `374bdb5cb8de7f4622917a343e379ff4cfd26232` remains 28,862,289 bytes with SHA-256 `45f1ebc82f1bae1d1cb767456c81fcf405d25b01d5e737c96b06f95084d0ef4c`. Neither is a Play release AAB, and neither has been installed on an emulator or physical device.
