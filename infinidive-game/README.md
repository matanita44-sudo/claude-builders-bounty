...
> **Current candidate refresh:** query-gated semantic Web QA is implemented on source fingerprint `7fb2ddb25e31c6711e75c7c96fd9f7d6be00863c46b327c04c51a8698e7b9363` with tests/CI fingerprint `d30ece3bad7997b749dedce70ff636575425d92aac017f6c9204ac3d6e99bc58`. Local strict editor plus the 13-suite matrix passed `28,410/0`; fresh 8.239-second and 90.184-second source-bound soaks passed. The public URL and older endurance/packages above still serve the prior runtime commit until the current candidate completes its mandatory 30-minute CI soak, semantic Chromium assertions, deployment, and retained-evidence refresh.
