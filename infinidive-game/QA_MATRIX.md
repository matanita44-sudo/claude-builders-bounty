...
|---|---|---|---|
| Web export artifact | HTML, JavaScript, WASM, PCK presence, excluded tooling/adaptive sources, and unresolved-shell token checks | PASS (local + current-commit remote) | Local commit-candidate static validation: HTML 2,618 / `190b5852ff3c94b4d2e6ce2849bdbc92cb64e77c6cb972d35165b9cf544713b5`; PCK 440,384 / `f9acf67d893ab6513f2b7fde450fcd2129331ba8252b3464132d94892b85b9d4`; WASM 39,514,754 / `fc74679e3b97f76878947fcd4fbe1268cbfa6188182a2e33bbc3f5dc9bfa57d0`. Current-commit Web job `99877839855` also passed with those sizes; remote artifact IDs are Pages `9803007777` and smoke `9803006599`. Local hashes are not attributed to the remote files. |
| Headless Chromium | Serve export over HTTP and wait for Godot `startGame()` completion | PASS (current-commit CI boot smoke) | Run 33514397476, commit `8e4be782`: HTTP 200; Godot 4.7.2; WebGL2; canvas 540×960; loading status hidden; no Playwright page errors. This is browser boot automation, not touch-gameplay, public-host, or physical-device evidence. |
...
| Android debug APK | Manifest, permission, alignment, signature, then install/launch/lifecycle smoke | PARTIAL | Local artifact is 28,878,673 bytes / SHA-256 `2d3d5fa6f283381fd31aa1702df2cc697c80f12d0d7a96e6c1e22b59c33cdcef` and passes structural validation despite a local build-tools 34.0.4 fallback warning. Separately, current-commit job `99877839931` passed with build-tools 36 and remote APK SHA-256 `9b981f4d0accc600ef8f869e600b16f5585533ea1fe4cf8c71a983cfbdd87172` in artifact `9802998519`. No emulator/device install occurred; neither is an AAB. |
