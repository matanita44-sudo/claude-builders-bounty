...
| Final frozen matrix total | `28,410 passed, 0 failed` across 13 invocations; editor import and all suites passed the strict wrapper with zero engine `ERROR`, script-error, or parse-error lines. Production fingerprint `8e9810de2615332713f86f47bf2f28f38728fb75e51ea5bfaf2d16760927d863`; tests/CI fingerprint `db398ae7804cf75e6741e13380993f9425d42b3e44de8da62631f159595f1597`. The JUnit file contains the `2,631/0` main suite. |
...
| Historical 30-minute soak result | `PASS` only for the process snapshot loaded at soak start — `1800.019s`, seed `203541`, zero recorded failures. Production files changed during execution, so it does not validate the current source; a post-freeze 30-minute RC rerun remains missing. |
...
| Final bounded soak | `8.014s`, 87 cycles, 9 boss restarts/Dives, 6 saves, 529 queued offline events / 2 queue reloads / final queue 500, peak 540, 7/7, unchanged fingerprint `8e9810de2615332713f86f47bf2f28f38728fb75e51ea5bfaf2d16760927d863`, complete transaction `b5a5db690e1513095a2cf63f`, zero failures. JSON `dbcbf0bdb4fc9e6fb763a5c344f274872cb13875696764fe118a4bf8c3901bdb`; Markdown/bound hash `15cd17499c54496ad909536039a3706f46c2fc197c856aa4b9fd89feaf2f5167`. |
...
| Final 90-second soak | Same transactional/source-lock acceptance as the bounded smoke | PASS — `90.118s`, 1,141 cycles, 115 restarts/Dives, 58 saves, 634 queued offline events / 3 queue reloads / final queue 500, peak 540, 7/7, stable delta 87,560 bytes, slope 216,364.835675299 B/min, complete transaction `22c5717c57c6018e8189b84f`, zero failures. JSON `119157a6aaf32943c30062dd2b51fe0ee1182b525b50acd0017c8f8c2150c5cf`; Markdown/bound hash `30c3b34a24347a5d6267929dc1a1f37bbd3b4a2f7374d64a6b446b6e66679bea`. |
| Transactional report recovery | Full-schema JSON/Markdown stage and commit as a two-phase pair with JSON-bound Markdown hash; completion is set only after cleanup; stale source/recovery reports are rejected; partial/early and source-change diagnostics persist as `FAIL` | PASS (writer transaction tests and CI `PASS`/diagnostic/negative fixtures; final red-team 0 P0/P1/P2) |
...
|---|---|---|---|
| Web export artifact | HTML, JavaScript, WASM, PCK presence, excluded tooling/adaptive sources, unresolved-shell token checks, and local HTTP paths | PASS (static/local HTTP) | Current HTML 2,618 / `65c3d9b290b3b3eb4baab5e8d677edee04ea3d0f4dc8331cf792e275a30c9f61`; JS 279,815 / `33c94cb3175f3333b82e2a3be5e8e86f77986f0aa2042b1631f6367a4e5bb6ba`; PCK 625,812 / `33283d7cfcf37fc5b1b5ccd5f77254766839bb674f9c8e1bd50cb7c3640ed43d`; WASM 39,514,754 / `fc74679e3b97f76878947fcd4fbe1268cbfa6188182a2e33bbc3f5dc9bfa57d0`. Local HTTP paths passed; no current real-browser/public-host claim. |
| Headless Chromium | Serve export over HTTP and wait for Godot `startGame()` completion | PASS (historical remote boot smoke only) | Historical run 33514397476, commit `8e4be782`: HTTP 200; Godot 4.7.2; WebGL2; canvas 540×960; loading status hidden; no Playwright page errors. The frozen local Web export has not received this browser smoke. This is not touch-gameplay, public-host, or physical-device evidence. |
...
| Public GitHub Pages URL | Post-deploy HTTP and runtime smoke at `https://matanita44-sudo.github.io/claude-builders-bounty/infinidive/` | BLOCKED / FAIL-CLOSED | Current deploy job `99878161111` failed exactly at Get Pages `Not Found` / Create Pages `Resource not accessible by integration`; direct game/support/privacy checks return HTTP 404 and no canvas. |
| Android debug APK | Manifest, permission, alignment, signature, then install/launch/lifecycle smoke | PARTIAL | Current APK `INFINIDIVE-0.1.0-prealpha-debug-8e9810de.apk` is 29,063,530 bytes / `d089cebf2207391634fa6b2719d9b8c0a56e654619c33b05292e47aacc78bfa6`; structural validation passed. No AAB, emulator/device install, or lifecycle result. |
...
| iOS Xcode project | Unsigned iPhone-targeted project structure and compile | PARTIAL / BLOCKED | Unsigned package `INFINIDIVE-0.1.0-prealpha-ios-unsigned-8e9810de.zip` contains current-source PCK 625,908 / `8cf2bd0732b1df958f65958cd45fee65d2387527f6a7cf08b6287dff1f3ccf83`; its headless main-pack probe passed. No Xcode compile/archive, signature, simulator run, install, or TestFlight result. |
...
| Historical 30-minute headless structural soak | Complete at least 1,800 wall-clock seconds without crash, soft-lock, recorded failure, or sustained high memory growth | PASS only for its loaded snapshot — 1,800.019 seconds, zero failures. It does not validate current source; the post-freeze 30-minute RC rerun remains missing. |
| Frozen source-locked transactional soaks | Confirm no source drift, semantic exercise, 7/7 models, complete two-phase pair, and current-source fingerprint | PASS — final 8.014-second and 90.118-second pairs share unchanged fingerprint `8e9810de2615332713f86f47bf2f28f38728fb75e51ea5bfaf2d16760927d863`, complete distinct transactions, and record zero failures; 90s stable delta 87,560 bytes / slope 216,364.835675299 B/min |
...
Production files were edited while the older 30-minute process was running, so that report validates only its loaded snapshot. The final tree passed the complete 13-suite matrix (`28,410/0`) and final 8.014-second/90.118-second current-source transactional soaks. RC evidence still requires a full 30-minute rerun after commit freeze.
...
| QA-RISK-007 | P1 for RC evidence | The final 8.014-second and 90.118-second transactional pairs pass, but the only completed 30-minute soak loaded a snapshot while production files were being edited concurrently | Re-run the full 30-minute soak after code freeze and record the exact commit hash |
...
6. Install the frozen Android debug build, produce a full frozen-source iOS export/compile/archive, then complete the named physical-device matrix without extrapolating from headless or browser evidence.
