...
const CONTENT := {
	"boss": {
		"gravemaw": {
			"name": "לוע הקבר",
			"subtitle": "טורף המסלולים",
			"fantasy": "אסטרואיד חי שהופך ציים שבלע לשריון עצמות."
		},
		"seraph_9": {
			"name": "שרף-9",
			"subtitle": "מנוע האל המת",
			"fantasy": "מכונת־מלאך ביומכנית, שהסגידה לה הפכה לקוד בר־ביצוע."
		},
		"abyss_leviathan": {
			"name": "לווייתן התהום",
			"subtitle": "צלופח הקרעים",
			"fantasy": "צלופח קוסמי השוחה דרך קרעים במרחק עצמו."
		},
		"null_twin": {
			"name": "תאום האפס",
			"subtitle": "אורגניזם המראה",
			"fantasy": "צורת חיים כפולה שלומדת את הצולל ומצמיחה השתקפות חמושה."
		}
	},
	"organ": {
		"hunter_eye": {
			"name": "עין הצייד",
			"effect": "מטחים מתבייתים מאבדים נעילה והופכים ליריות ישרות."
		},
		"gravity_lung": {
			"name": "ריאת הכבידה",
			"effect": "טבעות הכבידה מואטות והפער הבטוח שלהן מתרחב."
		},
		"bone_forge": {
			"name": "כור העצמות",
			"effect": "פתחי טילי העצם נאטמים עד סוף הקרב."
		},
		"prism_cortex": {
			"name": "קליפת המנסרה",
			"effect": "רמחי המנסרה מאבדים קרן מוחזרת אחת ומתריעים זמן רב יותר."
		},
		"wing_reactor": {
			"name": "כור הכנף",
			"effect": "כנף לייזר אחת קורסת ומשאירה אגף בטוח קבוע."
		},
		"halo_choir": {
			"name": "מקהלת ההילה",
			"effect": "מחסום ההילה נסדק ואינו נסגר עוד לחלוטין."
		},
		"vortex_stomach": {
			"name": "קיבת המערבולת",
			"effect": "גלי היניקה נחלשים ומשאירים תעלה רגועה ורחבה יותר."
		},
		"shock_gland": {
			"name": "בלוטת ההלם",
			"effect": "קשתות חשמל מפסיקות לשרשר דרך סכנות סמוכות."
		},
		"brood_sac": {
			"name": "שק השרצים",
			"effect": "פתחי הטפילים נאטמים ונחילים חיצוניים חדשים אינם יכולים להיווצר."
		},
		"memory_cortex": {
			"name": "קליפת הזיכרון",
			"effect": "התאום שוכח את הנשק המצויד ומפסיק להעתיק את יריותיו."
		},
		"echo_heart": {
			"name": "לב ההד",
		...
		"reflection_lattice": {
			"name": "סריג ההשתקפות",
			"effect": "פצעים מזויפים קורסים והרקמה הפגיעה האמיתית נשארת גלויה."
		}
	},
	"weapon": {
		"pulse_needle": {
			"name": "מחט פעימה",
			"description": "מהירה, מדויקת ואמינה בכל טווח.",
