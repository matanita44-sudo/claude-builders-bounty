...
Commit `8e4be78267a043072827963d6492c7964239ae94` has both local structural and remote CI evidence. Local hashes remain artifact-specific: Web HTML 2,618 / `190b5852ff3c94b4d2e6ce2849bdbc92cb64e77c6cb972d35165b9cf544713b5`, PCK 440,384 / `f9acf67d893ab6513f2b7fde450fcd2129331ba8252b3464132d94892b85b9d4`, WASM 39,514,754 / `fc74679e3b97f76878947fcd4fbe1268cbfa6188182a2e33bbc3f5dc9bfa57d0`; local Android APK 28,878,673 / `2d3d5fa6f283381fd31aa1702df2cc697c80f12d0d7a96e6c1e22b59c33cdcef`, with a local build-tools 34.0.4 fallback warning. Separately, Actions run 33514397476 passed all eight validation suites, current-commit Web export/Chromium boot, and Android debug using build-tools 36. The remote Android APK is `9b981f4d0accc600ef8f869e600b16f5585533ea1fe4cf8c71a983cfbdd87172` in artifact `9802998519`; remote Web/Smoke artifacts are `9803007777`/`9803006599`. The Chromium smoke returned HTTP 200, Godot 4.7.2, WebGL2, canvas 540×960, hidden loading status, and no page errors, but did not drive touch gameplay, mobile Safari/Chrome, reload persistence, or the public URL. Deploy job 99878161111 failed exactly at Get Pages `Not Found` / Create Pages `Resource not accessible by integration`; direct game/support/privacy checks remain HTTP 404 with no canvas. Full current-tree iOS project export failed because the Development Team is blank. `--export-pack iOS` refreshed only the retained scaffold's PCK to 440,480 bytes / `ac426ba74dd8993ea129448d2258d4f1b36ea3ee2fd48c28fd342bda53401db6`; the unchanged scaffold was not re-exported and nothing has been compiled, archived, signed, simulator-run, or installed. Background/resume, interruption, and target-device performance profiles remain absent.
