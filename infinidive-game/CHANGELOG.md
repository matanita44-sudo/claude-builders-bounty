...
- Current candidate fingerprints are production `1db2d97aa0852a415ee4a76e3d4be6ea20949140dfcdee46e49d295e55525e8e` and tracked tests/CI `ff2530d3aad779a21a3b775e8d973ba1b3e3c37a86b5b97cea133801c954dc59`. Strict editor import and all 13 suites passed `28,410/0` with zero engine/script/parse errors. Fresh 8.049-second, 90.041-second, and 1,800.035-second source-bound reports passed 7/7 model coverage with zero failures. Candidate run `33572931398` also passed CI-served and deployed public-host semantic Chromium movement/Dash smoke. This remains a pre-alpha boundary: the automation does not cover the complete breach/Dive/organ-return/reload path, Mobile Safari/Chrome, native install, target-device performance, or human control feel.
...
- Current-source 30-minute artifact `9826413723` is 9,008 bytes / `1290cf7b8cf81b64dd6f0b43e55739f4f3bbaa24d4b40a083d6dbf1296b03a63`. It passed for 1,800.035 seconds with unchanged fingerprint `1db2d97aa0852a415ee4a76e3d4be6ea20949140dfcdee46e49d295e55525e8e`, 27,043 cycles, 2,705 restarts / 2,705 Dives, 1,353 saves / 22 reloads, 3,224 queue events / 24 reloads / final 500, 1,659,358 player and 3,260,252 enemy projectile spawns, peak 540, peak 1,597 objects / 32 nodes / zero orphan nodes, stable delta 3,296,336 bytes, slope 88,712.5106369138 B/min, 7/7 travel models, and zero failures. Transaction `9f396a0becf39225c7580401` is complete; JSON is 53,728 bytes / `be3c3d795d31e9581e6fa108f462f58cd3264d9f24aff4d338a79123e485ed09`, and Markdown is 1,091 bytes / bound `d24fe59b37296f6006bb27dc18b61f3ff4996bbfdfc354d852af1377c3ab64b3`.
...
- The earlier pre-transactional soak reports were superseded by the current-source 8.049-second, 90.041-second, and 1,800.035-second transactional evidence recorded under `[Unreleased]`; the `e942db6f` pairs remain labeled as historical comparison only.
