...
The current `8.031s`, `90.048s`, and `1800.043s` structural-soak pairs all use unchanged fingerprint `e942db6f8a0f1a47518e8afb468f77c651001a2028fcad0820e71c4d993a6382`, execute 7/7 requested-versus-executed travel models, complete their two-phase transactions, and report zero failures. The bounded pair records 86 cycles, 9 restarts / 9 Dives, 6 saves, and transaction `9ac05a1b4bcc696001e5a6e7`; its JSON/Markdown hashes are `d8d5c6c5b0667f3b53844839f5955841430e85842ea168220c1a0d8ca4b5c1e9` / `9ba26093ba394c70b591130544a21094e719d0801d55755d82fd0e5c93814c27`. The 90-second pair records 1,169 cycles, 117 restarts / 117 Dives, 60 saves, 637 offline events / 3 queue reloads / final 500, stable delta 90,040 bytes, slope 218,786.041893738 B/min, and transaction `26dad83d28067418d76982a3`; its hashes are `2bc054556fe9e0c75813feb7e50dfcae5844c8140e4491bfd599e9129309c4c1` / `026962ed338b02db99cfee0ecb08bc16b197c9b2abd1544214e11ed61e69ab83`.

The current-source 30-minute pair was completed by Actions run `33559947112`, long-soak job `100030992601`, and retained in artifact `9822001845`. It records 26,676 cycles, 2,668 restarts / 2,668 Dives, 1,335 saves / 22 reloads, 3,188 offline events / 24 queue reloads / final 500, 1,636,943 player and 3,216,180 enemy projectile spawns, peak 540, baseline/final nodes 11/10, orphan peak 0, stable delta 3,667,676 bytes, and slope 84,517.9971965645 B/min. Transaction `5c047f1a630e8e1de5c5ffff` is bound to JSON `2f8171e8317572f31fd479884edcaa441452082640a9be4f3fe9339da02710b4` and Markdown `a508864e78c75981e8221df2c53f0ed97c82501295e999328fa86b78970f1856`. This remains Linux headless structural evidence: it does not prove human control feel, browser/device presentation, target-device performance, background/force-close behavior, migration from a previously shipped fixture, repeated Abyss depths, or native installation.
